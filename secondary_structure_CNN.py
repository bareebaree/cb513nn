...
num_classes = len(dssp3_classes)
model = ResidueLevelCNNLSTM(input_size, num_classes)
criterion = nn.CrossEntropyLoss(weight=torch.tensor([1.0, 1.0, 1.0]), ignore_index=-1)
learning_rate_schedule = {0: 0.0025, 150: 0.0015, 170: 0.001, 180: 0.00050, 210: 0.00025, 230: 0.0001}
